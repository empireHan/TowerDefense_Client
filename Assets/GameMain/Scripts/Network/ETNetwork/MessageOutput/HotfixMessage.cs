...
namespace Flower {
  ...
  public partial class G2C_PlayerInfo : pb::IMessage {
    ...
    private global::Flower.PlayerInfo playerInfo_;
    public global::Flower.PlayerInfo PlayerInfo {
    ...
    private static readonly pb::FieldCodec<global::Flower.PlayerInfo> _repeated_playerInfos_codec
        = pb::FieldCodec.ForMessage(18, global::Flower.PlayerInfo.Parser);
    private pbc::RepeatedField<global::Flower.PlayerInfo> playerInfos_ = new pbc::RepeatedField<global::Flower.PlayerInfo>();
    public pbc::RepeatedField<global::Flower.PlayerInfo> PlayerInfos {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (playerInfo_ == null) {
              playerInfo_ = new global::Flower.PlayerInfo();
            }
  ...
  public partial class LevelConfig : pb::IMessage {
    private static readonly pb::MessageParser<LevelConfig> _parser = new pb::MessageParser<LevelConfig>(() => (LevelConfig)MessagePool.Instance.Fetch(typeof(LevelConfig)));
    ...
    public int CalculateSize() {
      ...
      if (LevelIndex != 0) {
        size += 2 + pb::CodedOutputStream.ComputeInt32Size(LevelIndex);
      }
      if (Config.Length != 0) {
  ...
  public partial class R2C_LevelConfig : pb::IMessage {
    private static readonly pb::MessageParser<R2C_LevelConfig> _parser = new pb::MessageParser<R2C_LevelConfig>(() => (R2C_LevelConfig)MessagePool.Instance.Fetch(typeof(R2C_LevelConfig)));
    public static pb::MessageParser<R2C_LevelConfig> Parser { get { return _parser; } }
    ...
    private static readonly pb::FieldCodec<global::Flower.LevelConfig> _repeated_levelConfigs_codec
        = pb::FieldCodec.ForMessage(746, global::Flower.LevelConfig.Parser);
    private pbc::RepeatedField<global::Flower.LevelConfig> levelConfigs_ = new pbc::RepeatedField<global::Flower.LevelConfig>();
    public pbc::RepeatedField<global::Flower.LevelConfig> LevelConfigs {
      get { return levelConfigs_; }
      set { levelConfigs_ = value; }
    }
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      levelConfigs_.WriteTo(output, _repeated_levelConfigs_codec);
    }
    ...
    public int CalculateSize() {
      ...
      size += levelConfigs_.CalculateSize(_repeated_levelConfigs_codec);
      return size;
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      error_ = 0;
      message_ = "";
      for (int i = 0; i < levelConfigs_.Count; i++) { MessagePool.Instance.Recycle(levelConfigs_[i]); }
      levelConfigs_.Clear();
      uint tag;
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 746: {
            levelConfigs_.AddEntriesFrom(input, _repeated_levelConfigs_codec);
            break;
          }
        }
      }
